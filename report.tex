...
valutarli pi\`u volte. Il valore degli stati di gioco non finali viene stimato % Qua si passa dalla cache all'euristica. Meglio separare?
...
Dopo aver aggiornato la copia locale della griglia di gioco si cerca la cella % Aggiornato con cosa?
...
%Tuttavia aumenta sicuramente il numero di operazioni svolte dal calcolatore. https://initaliano.wordpress.com/2010/01/25/iniziare-con-tuttavia-ma-pero/
...
falsi positivi si confrontano il numero di mosse e l'ultimo simbolo giocato. % Falsi positivi in corsivetto. So che non ti piace ma è un modo di dire strano...
% La cache viene inizializzata all'inizio della partita in un thread dedicato. Avevamo detto di levare questa frase
