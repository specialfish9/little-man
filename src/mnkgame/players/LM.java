...
public class LM implements MNKPlayer {
  ...
  private int evaluate(boolean raw) {
  ...
  private int pvs(int color, int depth, int alpha, int beta) {
    ...
    else if (depth <= 0 || board.gameState() != MNKGameState.OPEN) return color * evaluate(false);
